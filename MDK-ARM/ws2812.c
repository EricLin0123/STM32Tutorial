...
void ws2812_test_set_color(uint8_t R, uint8_t G, uint8_t B, uint16_t num)
{
...
void ws2812_test_example(void)
{

    updateLength(numLEDs);
    ws2812_test_set_color(0x22, 0x00, 0x00, 1);
    ws2812_test_set_color(0x00, 0x22, 0x00, 2);
    ws2812_test_set_color(0x00, 0x00, 0x22, 3);
    ws2812_test_set_color(0x22, 0x22, 0x22, 0);
...
void updateLength(uint16_t n)
{
    ...
    numBytes = n * 3;
    if ((pixels = (uint8_t *)malloc(RESET_PULSE + numBytes)))
    {
        memset(pixels, 0, RESET_PULSE + numBytes);
        numLEDs = n;
    }
    else
    {
