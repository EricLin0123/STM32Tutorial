...
HAL_StatusTypeDef ADXL345_Init(void)
{
    ...
    else
    {
        ...
        ADXL345_Write(ADXL345_DATA_FORMAT, 0x29); // 00101001
        ADXL345_Write(ADXL345_BW_RATE, 0x1A);
        ADXL345_Write(ADXL345_POWER_CTL, 0x08);
        ADXL345_Write(ADXL345_THRESH_TAP, 0x2a); // 40 * 62.5 mg/LSB = 2.5 g
...
void ADXL345_Test(void)
{
    ...
    uint8_t intsrc;
    ADXL345_Rread(ADXL345_INT_SOURCE, &intsrc);
    sprintf(str, "int: %02x", intsrc);
    OLED_ShowString(0, 4, (char *)str, 8);
}
